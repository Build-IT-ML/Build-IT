                    ...
                    <div className="h-max w-full px-3 md:px-24">
                        <div className="flex flex-col md:flex-row justify-between mt-20 mb-20 md:mb-96">
                            <div className="flex flex-col z-20">
                                ...
                                <a href="https://drive.google.com/file/d/1plQLBL-_QcytYDpSP36EGcSBG2EXhWEU/view?usp=sharing" target="_blank" className="">                            
                            ...
                            <div className="w-full mt-20 flex justify-center mb-36">
                                <img src="../../../asset/images/modul/basis-image.png" alt="test" 
    ...
    return (
        <div data-aos="fade-up" className="flex justify-center items-center">
            <div className="relative w-[285px] h-[403px] cursor-pointer transform-style-preserve-3d transition-transform duration-700 hover-rotate-y-180">
                ...
                <a href={userInstagram} className="text-primary flex flex-row justify-center items-center gap-2">
